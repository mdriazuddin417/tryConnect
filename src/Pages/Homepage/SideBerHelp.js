  ...
  return (
    <>
      {open ? (
        ...
        <div className=" p-[35px] bg-white  border border-gray-200 rounded-tr-2xl rounded-br-2xl w-[400px] h-[620px] home-sidebar z-50">
          <p
            onClick={() => setOpen(!open)}
          ...
          <p className="text-sm text-gray-700 my-5">
            In this interactive demo, act as Alice to obtain credentials and use
          ...
          <div>
            ...
            <div className=" text-sm mt-3 space-y-3">
              ...
              <p>
                Through the Connect.Me app, a third party can request to view a
